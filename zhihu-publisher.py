...
GITHUB_REPO_PREFIX = "https://raw.githubusercontent.com/ruin2/myblog/master/"
...
def process_for_zhihu():
    ...
    with open(str(args.input),"r",encoding=chatest["encoding"]) as f:
        ...
        with open(args.input.parent/("D:/知乎/"+args.input.stem+"_for_zhihu.md"), "w+", encoding=chatest["encoding"]) as fw:
            fw.write(lines)
        git_ops()
...
if __name__ == "__main__":
    ...
    my_default = './{}.md'.format('GNN相关博客')
    args.input = my_default
